...
elements.push.apply(elements, $('h2'));
elements.push.apply(elements, $('h3'));
elements.push.apply(elements, $('h4'));
elements.push.apply(elements, $('p'));

var i = 0;
var length = elements.length;
var interval = setInterval(timer, 1000);
function timer() {
  $(elements[i]).click(function(e){$(this).jqFloat('stop')})
  $(elements[i]).jqFloat()
  i++;
  if(i > length){
  abortTimer();
